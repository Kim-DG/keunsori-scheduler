                              ...
                              Transform.scale(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: TextButton(
                                      onPressed: () {
                                        setDialogState(() {
                                          if (difficulty[mapDifficulty['K1']] ==
                                              5) {
                              ...
                              Transform.scale(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: TextButton(
                                      onPressed: () {
                                        setDialogState(() {
                                          if (difficulty[mapDifficulty['K2']] ==
                                              5) {
                              ...
                              Transform.scale(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: TextButton(
                                      onPressed: () {
                                        setDialogState(() {
                                          if (difficulty[mapDifficulty['K3']] ==
                                              5) {
                        ...
                        child: TextButton(
                          onPressed: () {
                            setState(() {
                              ...
                              listSongInfo[index] = ApiSongInfo(
                                  songInfo.id,
                                  concertId,
                                  songInfo.selectorName,
                                  singerName,
          ...
          children: [
                    ...
                    Transform.scale(
                        ...
                        child: SizedBox(
                          ...
                          child: TextButton(
                            onPressed: () {
                              setDialogState(() {
                                if (listDifficulty[mapDifficulty['Bass']] ==
                                    5) {
                    ...
                    Transform.scale(
                        ...
                        child: SizedBox(
                          ...
                          child: TextButton(
                            onPressed: () {
                              setDialogState(() {
                                if (listDifficulty[mapDifficulty['Drum']] ==
                                    5) {
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  setState(() {
                    if (selectorNameTextEditController.text == '' ||
                        singerNameTextEditController.text == '' ||
                        songNameTextEditController.text == '') {
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return GestureDetector(
                              ...
                              onVerticalDragUpdate: (detail) {
                                if (detail.primaryDelta! > 3.0) {
                                  if(listSongInfo[index].link != null || listSongInfo[index].link != ''){
                                    _launchURL(listSongInfo[index].link!);
                                  }
                                }
                              },
                              child: Container(
